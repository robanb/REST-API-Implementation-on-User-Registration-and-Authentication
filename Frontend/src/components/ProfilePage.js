					...
					<div className=" h-100 w-96 bg-opacity-0 bg-gray-900 rounded-2xl shadow-5xl shadow-violet-900 mt-16 ">
							...
							<Flowbite.Card >
								...
								<div className="flex flex-row">
									<Flowbite.Button className="mx-10" color="success" onClick={() => setEditModal(true)}>Edit</Flowbite.Button>
									<Flowbite.Button className="mx-10" color="failure" onClick={() => setDeleteModal(true)}>Delete</Flowbite.Button>
								</div>
								</div>
							</Flowbite.Card>
						</div>
