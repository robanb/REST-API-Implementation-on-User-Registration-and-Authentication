...
export default function Setting() {
	return (
		<div className="bg-gray-800 h-screen w-screen relative overflow-hidden flex justify-center items-center ">
			...
			<div className="h-screen w-screen bg-opacity-70 backdrop-blur-sm  ">
				<Navigation />
				<div className="grid grid-cols gap-4 place-items-center mt-10">
					<div className="mx-auto">
						<Flowbite.Card className="rounded-2xl shadow-5xl shadow-violet-900 mt-16">
							<h5 className=" text-base font-semibold text-gray-900 dark:text-white lg:text-xl text-center">
								Connect wallet
							</h5>
